---
title: "Quarto Dashboards<br>Components"
footer: "[quarto.org](https://quarto.org/)"
logo: "images/quarto-logo.png"
image: "images/thumbnail-2.png"
image-alt: "An illustration of dashboard components including a sidebar, pages, tabs, rows, and columns."
format:
  revealjs:
...
::: {.column width="50%"}
c. [**Results in an output, which will be placed in a card!**]{style="color:#589398;"}
...
If a cell generates multiple outputs, they get wrapped in a single card:
...
-   Slides for this video: [mine.quarto.pub/quarto-dashboards/2-dashboard-components](https://mine.quarto.pub/quarto-dashboards/2-dashboard-components/)
